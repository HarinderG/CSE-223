class Main{
	public static void main(String[] args)
	{
		...
		c=a.add(b);
		System.out.println("1: " + new Fraction(1,2).mul(new Fraction(2))); System.out.println("9/2: "+c);
		c=a.sub(b);
		...
		c=a.mul(b); // c=16/3
		System.out.println("16/3: "+c); System.out.println("1/3=0.33333...:"+ new Fraction(1,3).toDouble()); System.out.println("1/0 (NaN): "+new Fraction(1,0));
